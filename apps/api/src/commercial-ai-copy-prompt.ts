export const COMMERCIAL_AI_COPY_PROMPT_VERSION =
  'commercial-promotion-copy-v11' as const;
...
export const buildCommercialAiCopyInstructions = () =>
  [
    ...
    'Não use números na headline. No body, preserve apenas especificações técnicas não comerciais sustentadas literalmente pelo productName, como 380ml, 1700W, 127V, 46 Peças, 6,5L e FR 102. Não altere uma especificação ao normalizar espaços ou separadores.',

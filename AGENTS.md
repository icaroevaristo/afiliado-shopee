...
- `system:maintenance:migrate -- --confirm-operational-migrations` exige pausa,
  ...
  Nao inicia aplicacao/providers; termina em maintenance com PostgreSQL disponivel.
  Compartilha lock com start/stop; lock de migration interrompida exige investigacao
  humana e nunca e recuperado automaticamente. Escritores externos precisam ficar
